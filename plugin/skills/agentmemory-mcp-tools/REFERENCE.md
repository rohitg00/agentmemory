...
| `memory_smart_search` | yes | `query`*: string, `expandIds`: string, `limit`: number, `start_time`: string, `end_time`: string | Hybrid semantic+keyword search with progressive disclosure. |
