...
| `memory_lesson_list` |  | `project`: string, `source`: string, `minConfidence`: number, `limit`: number | List saved lessons, optionally filtered by project, source, and confidence. |
