...
Generated from `src/triggers/api.ts`. Do not edit the block below by hand; run `corepack pnpm run skills:gen` after changing the registered endpoints.
