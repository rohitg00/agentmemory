...
| POST | `/agentmemory/orcarouter/connect/cancel` |
| POST | `/agentmemory/orcarouter/connect/start` |
| GET | `/agentmemory/orcarouter/connect/status` |
| POST | `/agentmemory/orcarouter/key` |
| GET | `/agentmemory/orcarouter/models` |
| POST | `/agentmemory/orcarouter/signout` |
| GET | `/agentmemory/orcarouter/status` |
