...
//              so Cursor never waits on this hook at the end of a response.
//   worker  -> performs the (possibly slow, remote) summarize call, then force-exits.
...
async function runWorker() {
  // Absolute backstop: even if the request wedges past its AbortSignal, force-kill.
