...
# from the Coolify deploy logs. On subsequent boots the file already
# exists and we just load it.
#
# To rotate: delete the file and restart the application from the
# Coolify dashboard. The next boot will print a fresh secret.
