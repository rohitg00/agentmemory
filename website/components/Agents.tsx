...
const FEATURED: Agent[] = [
  {
    ...
    name: "Claude Code",
    from: "Anthropic",
    logo: "https://svgl.app/library/anthropic.svg",
    accent: "#CC785C",
  ...
  },
  {
    ...
    name: "Copilot CLI",
    from: "GitHub",
    logo: "https://svgl.app/library/github.svg",
    accent: "#24292E",
  ...
  },
  {
    ...
    name: "OpenClaw",
    from: "openclaw",
    logo: "https://openclaw.com/favicon.svg",
    accent: "#FFA000",
...
const MARQUEE: Agent[] = [
  ...
  },
  {
    ...
    name: "Continue",
    from: "Continue.dev",
    logo: "https://svgl.app/library/continue.svg",
    accent: "#000000",
  ...
  },
  {
    ...
    name: "Zed",
    from: "Zed Industries",
    logo: "https://svgl.app/library/zed.svg",
    accent: "#FF4500",
    href: "https://zed.dev",
  },
  {
  ...
  },
  {
    ...
    name: "Gemini CLI",
    from: "Google",
    logo: "https://svgl.app/library/google_gemini.svg",
    accent: "#4285F4",
  ...
  },
  {
    ...
    name: "Qwen Code",
    from: "Alibaba",
    logo: "https://svgl.app/library/qwen.svg",
    accent: "#615CED",
  ...
  },
  {
    ...
    name: "Kiro",
    from: "AWS",
    logo: "https://kiro.dev/favicon.svg",
    accent: "#FF9900",
    href: "https://kiro.dev",
  },
  {
  ...
  },
  {
    ...
    name: "Goose",
    from: "Block",
    logo: "https://block.github.io/goose/img/logo_dark.png",
    accent: "#00D54B",
  ...
  },
  {
    ...
    name: "Aider",
    from: "Aider-AI",
    logo: "https://aider.chat/assets/icons/favicon-32x32.png",
    accent: "#E11D48",
  ...
  },
  {
    ...
    name: "Windsurf",
    from: "Cognition",
    logo: "https://svgl.app/library/windsurf.svg",
    accent: "#00A699",
