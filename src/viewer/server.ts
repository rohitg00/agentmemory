...
function isAllowedOrigin(origin: string): boolean {
  ...
  // When bound to 0.0.0.0, allow any origin on the configured ports
  // so that external clients can access the viewer without pre-configuring
  // VIEWER_ALLOWED_ORIGINS for every possible hostname/IP.
