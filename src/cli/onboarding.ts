...
const PROVIDERS: { value: string; label: string; envKey: string | null }[] = [
  ...
  { value: "requesty", label: "Requesty — multi-model router", envKey: "REQUESTY_API_KEY" },
...
const PROVIDER_COST_HINTS: Record<string, string> = {
  ...
  requesty: "rough cost: pick a small model; spend tracks your chosen model's per-token price.",
