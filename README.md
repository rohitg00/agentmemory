...
| **Atlas Cloud** | `OPENAI_API_KEY=<atlascloud-key>` + `OPENAI_BASE_URL=https://api.atlascloud.ai/v1` + `OPENAI_MODEL=deepseek-ai/deepseek-v4-pro` | [Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=agentmemory) — full-modal OpenAI-compatible gateway (DeepSeek, Qwen, GLM, Kimi, MiniMax, …). |
