...
| `AGENTMEMORY_REQUIRE_HTTPS` | (off) | When set to `1`, refuse to send either credential over plaintext HTTP to a non-loopback host. With this off, the plugin warns once but still sends. |
