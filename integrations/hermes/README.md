...
an MCP server with all 53 memory tools:
...
This gives Hermes access to all 53 MCP tools and enables the agentmemory memory provider. Start the server separately:
